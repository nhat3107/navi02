...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, type, className = '', inputClassName = '', ...props }, ref) => {
      ...
      <div className={`flex flex-col gap-1 ${className}`}>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-3.5 py-2.5 text-[0.935rem] text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 border-[1.5px] rounded-xl outline-none transition-all duration-150 placeholder:text-slate-400 dark:placeholder:text-slate-500 ${inputClassName} ${
              error
